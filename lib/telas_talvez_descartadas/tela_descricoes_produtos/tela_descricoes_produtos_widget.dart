...
import 'tela_descricoes_produtos_model.dart';
export 'tela_descricoes_produtos_model.dart';

/// Food Item Detail View
class TelaDescricoesProdutosWidget extends StatefulWidget {
  const TelaDescricoesProdutosWidget({
    super.key,
  ...
  static String routeName = 'TelaDescricoes_Produtos';
  static String routePath = '/telaDescricoesProdutos';

  @override
  State<TelaDescricoesProdutosWidget> createState() =>
      _TelaDescricoesProdutosWidgetState();
}

class _TelaDescricoesProdutosWidgetState
    extends State<TelaDescricoesProdutosWidget> {
  late TelaDescricoesProdutosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaDescricoesProdutosModel());
