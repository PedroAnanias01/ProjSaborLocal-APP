...
import 'tela_descricoes_produtos_c_model.dart';
export 'tela_descricoes_produtos_c_model.dart';

/// Food Item Detail View
class TelaDescricoesProdutosCWidget extends StatefulWidget {
  const TelaDescricoesProdutosCWidget({
    super.key,
  ...
  static String routeName = 'TelaDescricoes_ProdutosC';
  static String routePath = '/telaDescricoesProdutosC';

  @override
  State<TelaDescricoesProdutosCWidget> createState() =>
      _TelaDescricoesProdutosCWidgetState();
}

class _TelaDescricoesProdutosCWidgetState
    extends State<TelaDescricoesProdutosCWidget> {
  late TelaDescricoesProdutosCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaDescricoesProdutosCModel());
